...
import { ArrowRight, Upload, Pencil, Send, Copy, XCircle, Search, LayoutGrid, List, Plus, FileStack, Wrench } from 'lucide-react'
...
import { ModalImportarOM } from '../components/ModalImportarOM'
...
export function Fila() {
  ...
  return (
    <Pagina titulo="Fila operacional" subtitulo={`${fila.length} demandas aguardando triagem ou envio ao planejamento · arraste um card para outra coluna para avançar a etapa`} acoes={<>
      ...
      {pode('fila.lancar') && <Botao onClick={() => setManutencao(true)} title="Consulta de OMs colada do Sisloc"><Wrench size={14} />Importar manutenções</Botao>}
      ...
      <ModalImportarOM aberto={manutencao} onFechar={() => setManutencao(false)} />
